export const defaultOptions = {
  ...
  ALPHABOT_SLEEP_BETWEEN_WAIT_FOR_REGISTERED: 10000,
  ...
  PREMINT_SLEEP_BETWEEN_WAIT_FOR_REGISTERED: 5000,
  ...
  LUCKYGO_SLEEP_BETWEEN_WAIT_FOR_REGISTERED: 2000,

  // SUPERFUL
  SUPERFUL_ENABLE: true,
  SUPERFUL_ENABLE_CLOUD: true,
  SUPERFUL_ENABLE_TWITTER_TASKS: true,
  SUPERFUL_ENABLE_DISCORD_TASKS: true,
  SUPERFUL_ENABLE_RESULTS: true,
  SUPERFUL_ENABLE_RAFFLE_LIST: true,
  SUPERFUL_WAIT_FOR_RAFFLE_PAGE_LOADED: 30000,
  SUPERFUL_SLEEP_BETWEEN_WAIT_FOR_REGISTERED: 5000,
  ...
  ATLAS_SLEEP_BETWEEN_WAIT_FOR_REGISTERED: 2000,
  ...
  PREMINT_RESULTS_MAX_FETCH_WINS: 500, //  300,
  ATLAS_RESULTS_MAX_FETCH_WINS: 5000, // 5000,
  LUCKYGO_RESULTS_MAX_FETCH_WINS: 500, //  300,
  SUPERFUL_RESULTS_MAX_FETCH_WINS: 500, //  300,

  RAFFLE_LIST_SEARCH_QUERY: [],
  RAFFLE_LIST_SEARCH_TOP: [],
  RAFFLE_LIST_SEARCH_GREAT: [],
  RAFFLE_LIST_SEARCH_GOOD: [],
  RAFFLE_LIST_SEARCH_EARLY: [],

  RAFFLE_LIST_MY_TEAMS: [],
  RAFFLE_LIST_FILTER_MINUTES: '',
  RAFFLE_LIST_FILTER_PCT: '',
  RAFFLE_LIST_FILTER_EASY: false,
  RAFFLE_LIST_FILTER_GTD: false,
...
export const overrideOptions = {
  ...
  TWITTER_LOOKUPS_SLEEP_BETWEEN: 5000,
  ...
  RAID_TEXTS: [
    ...
    'We are ready {EMOJI}',
    'We supporting {EMOJI}',
    'Here to support {EMOJI}',
    'Ready to support {EMOJI}',
    'Gogogogo! {EMOJI}',
    'Here! {EMOJI}',
  ],
  RAID_TEAM_TEXTS: [
  ...
  TWITTER_DELAY_BEFORE_CLICK_INTENT_BTN: 500,

  DISCORD_MAIN_LOOP_SLEEP: 1000,

  DEFAULT_LOCALE: 'sv-SE',

  TWITTER_INTENT_PAGE_FOCUS_TAB_TIMES: 2,
  TWITTER_INTENT_PAGE_NUM_RETRIES: 1,
  TWITTER_INTENT_PAGE_TIME_BEFORE_RETRY: 5000,
};
