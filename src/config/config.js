export const defaultOptions = {
  ...
  // ATLAS
  LUCKY_ENABLE: true,
  LUCKY_ENABLE_CLOUD: true,
  LUCKY_ENABLE_TWITTER_TASKS: true,
  LUCKY_ENABLE_DISCORD_TASKS: true,
  LUCKY_ENABLE_RESULTS: true,
  LUCKY_MAIN_REGION_SEL: 'Entry Requirements',
  LUCKY_REG_BTN_SEL: 'Register',
  LUCKY_MUST_LIKE_SEL: 'like',
  LUCKY_MUST_RETWEET_SEL: 'retweet',
  LUCKY_MUST_LIKE_AND_RETWEET_SEL: 'like & retweet',
  LUCKY_MUST_FOLLOW_SEL: 'follow',
  LUCKY_JOIN_DISCORD_SEL: 'join the',
  LUCKY_WAIT_FOR_RAFFLE_PAGE_LOADED: 30000,
  ...
  TWITTER_MAX_RESULTS_PAGE_LOOKUPS: 15,
...
export const overrideOptions = {
  ...
  LUCKY_RESULTS_MAX_FETCH_WINS: 300, //  300,
